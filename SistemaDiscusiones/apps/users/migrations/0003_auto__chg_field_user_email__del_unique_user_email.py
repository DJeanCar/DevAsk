...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_user', 'email', self.gf('django.db.models.fields.EmailField')(max_length=50, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.email'
        db.alter_column(u'users_user', 'email', self.gf('django.db.models.fields.EmailField')(max_length=50, unique=True))
